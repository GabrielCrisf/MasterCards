export function ouro(){
    ...
    const Ouro ={
        "1": {
            ...
            "CAMPO": ``,
            "DESCT": `(REAÇÃO): 'Quando este card for “Descartado: “Compre 1 cards.`,
            "TIPO": "CardNumero"
        },
        "2": {
           "MAO": "Quando um descarta for declarado, envie este card para o [LIXO]; Dobre o valor do “Descarte",
            ...
            "DESCT": `(REAÇÃO): 'Quando este card for “Descartado: “Compre 2 cards do topo do DECK.`,
            "TIPO": "CardNumero"
        },
        "3": {
            ...
            "DESCT": `(REAÇÃO): 'Quando este card for “Descartado: Reorganize os 5 cards do topo do seu deck colocando em qualquer ordem.`,
